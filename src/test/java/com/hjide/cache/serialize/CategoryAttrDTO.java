 ...
 */
public class CategoryAttrDTO extends CategoryBaseDTO implements Serializable, Cloneable {
    // 目录的ID号
    @Serialize
    private Long id;
    ...
    public static void main(String[] args){
        Field[] fields = CategoryAttrDTO.class.getDeclaredFields();
